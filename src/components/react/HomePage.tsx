    ...
    <ToastProvider>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-margin-mobile md:px-margin-desktop py-16 overflow-hidden mt-20">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-linear-to-b from-transparent via-surface/60 to-surface z-10" />
        </div>
        <div className="relative z-20 max-w-4xl text-center space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-8">
            <a
              href="/carte"
              className="forged-btn-primary px-8 py-4 font-label text-label tracking-widest flex items-center gap-2 uppercase">
              COMMANDER EN LIGNE
            ...
            <a
              ...
              download
              className="forged-btn px-8 py-4 font-label text-label tracking-widest uppercase text-aged-parchment">
        ...
        <div className="max-w-container-max mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            ...
            <div className="stone-slab md:col-span-2 p-12 flex flex-col text-center justify-between">
              {/* <div> */}
              <h2 className="font-headline text-hlg text-fired-gold mb-6">
                LES ATELIERS BOULANJ&apos;
              </h2>
              <p className="text-body-lg text-primary-fixed-dim max-w-xl mb-8">
                Apprenez l&apos;art du pain au levain, la manipulation des
                farines anciennes et les secrets d&apos;une fermentation lente.
                Une immersion totale dans notre univers artisanal.
              </p>

              <a
                href="/ateliers"
                className="forged-btn w-full py-4 font-label text-label uppercase text-aged-parchment">
                En savoir plus
              </a>
            </div>
            {/* Flour Card */}
            <div className="stone-slab p-12 flex flex-col items-center text-center justify-center">
              ...
              <h2 className="font-headline text-hmd text-aged-parchment mb-4">
                VENTE DE FARINES
              </h2>
              <p className="font-body text-body text-primary-fixed-dim/70 mb-8">
                Matières premières bio, locales et nobles sélectionnées avec
                soin pour vos créations personnelles.
              </p>
              <a
                href="/carte_des_farines.pdf"
                className="forged-btn w-full py-4 font-label text-label uppercase text-aged-parchment">
                Catalogue farines
              </a>
            </div>
      ...
      <section className="px-margin-mobile md:px-margin-desktop py-24">
        <div className="max-w-container-max mx-auto text-center mb-16">
          <h3 className="font-label text-label text-fired-gold tracking-[0.3em] uppercase mb-4">
            La Communauté
          </h3>
          <h2 className="font-headline text-hlg text-aged-parchment">
      ...
      <section className="px-margin-mobile md:px-margin-desktop py-24 bg-surface-container-high border-y border-iron-rim">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-headline text-hlg text-aged-parchment mb-4 uppercase">
            PRÊT À GOÛTER L&apos;AUTHENTIQUE ?
          </h2>
          <p className="font-body text-body-lg text-primary-fixed-dim mb-12">
            Plus d&rsquo;informations ou pour passer commande directement par
            téléphone ou email.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter mb-12">
            <a
              href="tel:+33652394879"
              className="stone-slab p-8 flex items-center justify-center gap-4">
              <span className="font-headline text-hmd text-aged-parchment">
                06.52.39.48.79
              </span>
            </a>
            <a
              ...
              className="stone-slab p-8 flex items-center justify-center gap-4">
              <span className="font-body text-body-lg font-medium text-aged-parchment">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 font-label text-label text-aged-parchment/60 hover:text-ember-orange transition-all uppercase tracking-widest">
              INSTAGRAM
            </a>
            <a
